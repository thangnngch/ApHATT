...
namespace APHATT.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,TraineeID,CourseID,StartEnrollmentDate,EndEnrollmentDate")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,TraineeID,CourseID,StartEnrollmentDate,EndEnrollmentDate")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
