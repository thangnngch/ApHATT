...
namespace APHATT.Controllers
{
    ...
    public class TopicsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopicID,TopicName,TopicDescriptions,CourseID")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopicID,TopicName,TopicDescriptions,CourseID")] Topic topic)
        {
            if (ModelState.IsValid)
            {
